...
<div class="about-grid">
    ...
    <div class="about-grid-content" style="background-image: linear-gradient(to bottom, rgba(193, 193, 193, 0.1), rgba(0, 0, 0, 0.4)), url('<?php echo get_sub_field('what-image') ; ?>')">
